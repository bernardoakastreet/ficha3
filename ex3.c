...
/*
3.1) O sinal SIGTERM foi apenas ignorado, não tendo sido bloqueado, e o sinal SIGUSR1 foi bloqueado, tendo ficado "pendente"
3.2) O processo foi no estado parado (T), não tendo sido terminado
3.3) O processo resumiu o funcionamento do programa em background
*/
